...
public class Questao5Activity extends Activity {
    ...
    public void playGolfinho (View v){ //ALTERAR PARA O ANIMAL
        if (player == null) {
            player = MediaPlayer.create(this, R.raw.golfinho);
        }
    ...
    public void certo5 (View v) {
        ...
        View popupView = inflater.inflate(R.layout.activity_pop_up5, null); //nao esquecer de trocar o pop up daqui
        ...
        Button btnproximo1 = (Button) popupView.findViewById(R.id.proximo5);
        btnproximo1.setOnClickListener(new Button.OnClickListener(){

            @Override
            public void onClick(View v) {
                Toast.makeText(Questao5Activity.this, "Acertou", Toast.LENGTH_SHORT).show();

                Intent intent = new Intent(Questao5Activity.this, Questao6Activity.class);
