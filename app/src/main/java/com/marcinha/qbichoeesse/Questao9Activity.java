...
public class Questao9Activity extends Activity {
    ...
    public void playVaca(View v) { //ALTERAR PARA O ANIMAL
        if (player == null) {
    ...
    public void certo9(View v) {
        ...
        View popupView = inflater.inflate(R.layout.activity_pop_up9, null); //nao esquecer de trocar o pop up daqui
        ...
        Button btnproximo1 = (Button) popupView.findViewById(R.id.proximo9);
        btnproximo1.setOnClickListener(new Button.OnClickListener() {

            @Override
            public void onClick(View v) {
                Toast.makeText(Questao9Activity.this, "Acertou", Toast.LENGTH_SHORT).show();

                Intent intent = new Intent(Questao9Activity.this, Questao10Activity.class);
