...
public class Questao8Activity extends Activity {
    ...
    public void playOnca(View v) { //ALTERAR PARA O ANIMAL
        if (player == null) {
            player = MediaPlayer.create(this, R.raw.onca);
        }
    ...
    public void certo8(View v) {
        ...
        View popupView = inflater.inflate(R.layout.activity_pop_up8, null); //nao esquecer de trocar o pop up daqui
        ...
        Button btnproximo1 = (Button) popupView.findViewById(R.id.proximo8);
        btnproximo1.setOnClickListener(new Button.OnClickListener() {

            @Override
            public void onClick(View v) {
                Toast.makeText(Questao8Activity.this, "Acertou", Toast.LENGTH_SHORT).show();

                Intent intent = new Intent(Questao8Activity.this, Questao9Activity.class);
