...
public class Questao4Activity extends Activity {
    ...
    public void playGalinha (View v){
        if (player == null) {
            player = MediaPlayer.create(this, R.raw.galinha);
        }
    ...
    public void certo4 (View v) {
        ...
        View popupView = inflater.inflate(R.layout.activity_pop_up4, null); //nao esquecer de trocar o pop up daqui
        ...
        Button btnproximo1 = (Button) popupView.findViewById(R.id.proximo4);
        btnproximo1.setOnClickListener(new Button.OnClickListener(){

            @Override
            public void onClick(View v) {
                Toast.makeText(Questao4Activity.this, "Acertou", Toast.LENGTH_SHORT).show();

                Intent intent = new Intent(Questao4Activity.this, Questao5Activity.class);
