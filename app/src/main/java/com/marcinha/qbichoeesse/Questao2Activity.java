...
public class Questao2Activity extends Activity {
    ...
    public void playCachorro (View v){
        if (player == null) {
        ...
        public void certo2 (View v) {
            ...
            View popupView = inflater.inflate(R.layout.activity_pop_up2, null); //nao esquecer de trocar o pop up daqui
            ...
            Button btnproximo1 = (Button) popupView.findViewById(R.id.proximo2);
            btnproximo1.setOnClickListener(new Button.OnClickListener(){

                @Override
                public void onClick(View v) {
                    Toast.makeText(Questao2Activity.this, "Acertou", Toast.LENGTH_SHORT).show();
