...
public class Questao6Activity extends Activity {
    ...
    public void playBode (View v){ //ALTERAR PARA O ANIMAL
        if (player == null) {
    ...
    public void certo6 (View v) {
        ...
        View popupView = inflater.inflate(R.layout.activity_pop_up6, null); //nao esquecer de trocar o pop up daqui
        ...
        Button btnproximo1 = (Button) popupView.findViewById(R.id.proximo6);
        btnproximo1.setOnClickListener(new Button.OnClickListener(){

            @Override
            public void onClick(View v) {
                Toast.makeText(Questao6Activity.this, "Acertou", Toast.LENGTH_SHORT).show();

                Intent intent = new Intent(Questao6Activity.this, Questao7Activity.class);
