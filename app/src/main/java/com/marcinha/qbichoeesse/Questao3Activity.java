...
public class Questao3Activity extends Activity {
    ...
    public void certo3 (View v) {
        ...
        View popupView = inflater.inflate(R.layout.activity_pop_up3, null); //nao esquecer de trocar o pop up daqui
        ...
        Button btnproximo1 = (Button) popupView.findViewById(R.id.proximo3);
        btnproximo1.setOnClickListener(new Button.OnClickListener(){

            @Override
            public void onClick(View v) {
                Toast.makeText(Questao3Activity.this, "Acertou", Toast.LENGTH_SHORT).show();
